...
export async function seedProductsAndWarehouses() {
  ...
  const privateProducts = [
    { crop: "Maize", variety: "RISHI-11", type: "private" },
    { crop: "Maize", variety: "RISHI-22", type: "private" },
    { crop: "Maize", variety: "RISHI-33", type: "private" },
    { crop: "Maize", variety: "RISHI-44", type: "private" },
    { crop: "Maize", variety: "RISHI-55", type: "private" },
    { crop: "Maize", variety: "RISHI-66", type: "private" },
    { crop: "Bitter Gourd", variety: "RISHI-18", type: "private" },
    { crop: "Bitter Gourd", variety: "APSARA", type: "private" },
    { crop: "Bottle Gourd", variety: "SWETHA", type: "private" },
    { crop: "Bottle Gourd", variety: "REKHA", type: "private" },
    { crop: "Cucumber", variety: "HARINI", type: "private" },
    { crop: "Ridge Gourd", variety: "RHR-786", type: "private" },
    { crop: "Watermelon", variety: "RISHI-5", type: "private" },
    { crop: "Watermelon", variety: "HIMABINDU", type: "private" },
    { crop: "Bhendi", variety: "RHB-101", type: "private" },
    { crop: "Bhendi", variety: "JOSH", type: "private" },
    { crop: "Bhendi", variety: "NEHA", type: "private" },
    { crop: "Chilli", variety: "YAGNA", type: "private" },
    { crop: "Chilli", variety: "GREESHMA", type: "private" },
    { crop: "Chilli", variety: "RHC-623", type: "private" },
    { crop: "Chilli", variety: "RHC-633", type: "private" },
    { crop: "Chilli", variety: "RHC-613", type: "private" },
    { crop: "Chilli", variety: "RHC-678", type: "private" },
    { crop: "Tomato", variety: "RHT-900", type: "private" },
    { crop: "Tomato", variety: "RHT-910", type: "private" },
    { crop: "Tomato", variety: "RHT-918", type: "private" },
    { crop: "Tomato", variety: "RHT-990", type: "private" },
    { crop: "Tomato", variety: "RHT-550", type: "private" },
    { crop: "Cluster Bean", variety: "RISHI-111", type: "private" },
    { crop: "Dolichos Bean", variety: "RDS-222", type: "private" },
    { crop: "Dolichos Bean", variety: "RDS-333", type: "private" },
    { crop: "Bajra", variety: "RISHI-555", type: "private" },
    { crop: "Jowar", variety: "RSH-20", type: "private" },
    { crop: "Castor", variety: "RHC-09", type: "private" },
    { crop: "Castor", variety: "RHC-19", type: "private" },
    { crop: "Red Gram", variety: "ARUN", type: "private" },
    { crop: "Sunflower", variety: "RHS-117", type: "private" },
    { crop: "Sunflower", variety: "RHS-118", type: "private" },
    { crop: "Paddy", variety: "NANDIKA-55", type: "private" },
    { crop: "French Bean", variety: "RDS-333", type: "private" },
  ];
